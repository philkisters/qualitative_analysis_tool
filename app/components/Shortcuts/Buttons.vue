<template>
  <div class="flex-1 flex flex-col gap-2">
    <div class="flex gap-2 justify-stretch">
      <UButton block color="secondary" label="Min mIoU" @click="goToImage(minMIOUId)" />
      <UButton block label="Max mIoU" @click="goToImage(maxMIOUId)" />
    </div>
    <div v-if="hasDelta" class="flex gap-2 justify-stretch">
      <UButton block icon="lucide-triangle" color="secondary" label="Min mIoU" @click="goToImage(minDeltaMIOUId)" />
      <UButton block icon="lucide-triangle" label="Max mIoU" @click="goToImage(maxDeltaMIOUId)" />
    </div>
    <div class="flex gap-2 justify-stretch mt-4">
      <UButton block color="secondary" label="Min Runtime" @click="goToImage(minTimeId)" />
      <UButton block label="Max Runtime" @click="goToImage(maxTimeId)" />
    </div>
    <div v-if="hasDelta" class="flex gap-2 justify-stretch">
      <UButton block icon="lucide-triangle" color="secondary" label="Min Runtime" @click="goToImage(minDeltaTimeId)" />
      <UButton block icon="lucide-triangle" label="Max Runtime" @click="goToImage(maxDeltaTimeId)" />
    </div>
    <div class="flex gap-2 justify-stretch mt-4">
      <UButton block color="secondary" label="Min Accuracy" @click="goToImage(minAccuracyId)" />
      <UButton block label="Max Accuracy" @click="goToImage(maxAccuracyId)" />
    </div>
    <div v-if="hasDelta" class="flex gap-2 justify-stretch">
      <UButton block icon="lucide-triangle" color="secondary" label="Min Accuracy" @click="goToImage(minDeltaAccuracyId)" />
      <UButton block icon="lucide-triangle" label="Max Accuracy" @click="goToImage(maxDeltaAccuracyId)" />
    </div>
    <div class="flex gap-2 justify-stretch mt-4">
      <UButton block color="secondary" label="Min Sparsity" @click="goToImage(minSparsityId)" />
      <UButton block label="Max Sparsity" @click="goToImage(maxSparsityId)" />
    </div>
  </div>
</template>
